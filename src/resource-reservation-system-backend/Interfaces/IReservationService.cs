...
{
  Task<IEnumerable<DetailedReservationDTO>> GetAllAsync();
  Task<IEnumerable<DetailedReservationDTO>> GetAllAsync(int page, int size, string sortBy);
  Task<IEnumerable<DetailedReservationDTO>> GetByResourceId(int id, int page, int size, string sortBy);
